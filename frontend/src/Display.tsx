...
function Display() {
  ...
  const components = {
    a: ({ children, ...props }: any) => {
      return (
        <Button variant="link" onClick={() => navigate(`/${props.href}`)} className="px-0 py-0! h-8! p-0! text-md text-blue-500" >
          {children}
        </Button>
      )
    },
    ...
    <div className="w-full h-screen flex flex-col">
      <div className="flex relative flex-1 min-h-0">
        ...
        <div className="flex-1 flex py-4 flex-col max-w-1/2 min-h-0">
          <h2 className="text-lg text-center bg-red-500 text-center!  font-semibold px-4 pb-4 text-foreground flex-shrink-0">Markdown</h2>
